...
export function ContactFormSection() {
  ...
  return (
    <section ref={sectionRef} id="contact" className="py-16 sm:py-20 bg-white scroll-mt-[4.5rem]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-12">
            ...
            >
              ...
              >
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  ...
                  >
                    {loading ? (locale === 'ar' ? 'جاري الإرسال...' : 'Sending...') : t('contact.form.submit')}
                  </Button>
                </motion.div>
              </form>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-4">
                {contactInfo.map(({ key, valueEn, valueAr, icon: Icon }, index) => (
                  <motion.li
                    key={key}
                    className={cn(
