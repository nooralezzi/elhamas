...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "footer.companyName": "Qafilat Al-Tawhid",
  ...
  ar: {
    ...
    "about.vision": "الرؤية",
    "about.vision.text":
      "أن نكون من الجهات الرائدة في تنظيم العمرة والخدمات السياحية المصاحبة، عبر بناء ثقة طويلة المدى وتقديم معيار جودة يليق بضيوف الرحمن.",
    ...
    "footer.companyName": "قافلة التوحيد",
